...
public class Uebungsblatt2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Uebungsblatt2";
	...
	private Uebungsblatt2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Uebungsblatt2PersistentManager();
		}
